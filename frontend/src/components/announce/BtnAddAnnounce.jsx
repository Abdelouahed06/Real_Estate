...
const BtnAddAnnounce = ({isToggle, toggle}) => {

    return (
        <div className='flex items-center gap-2 bg-red-500 rounded-lg p-2 cursor-pointer' onClick={() => toggle(!isToggle)}>
            ...
            <Link to='/add-announce' className='text-white'>Add New Announce</Link>
        </div>
    )
}

export default BtnAddAnnounce